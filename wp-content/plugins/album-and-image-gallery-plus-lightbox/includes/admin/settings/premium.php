		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					<!-- <h1 style="font-size: 28px; font-weight: 700; letter-spacing: -1px; text-align: center; margin-top: 30px; margin-bottom: 5px;">Only <span class="aigpl-sf-blue">November 2022</span> Deal <span class="aigpl-sf-blue">40% OFF</span></h1>
					...
					<h3><span style="text-decoration:line-through; color: #FF1000;">$299</span> <span class="aigpl-sf-blue" style="font-size:30px;">$179</span> Unlimited Site License</h3>
					<a href="<?php //echo AIGPL_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="aigpl-sf-btn aigpl-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
					...
					<a href="<?php echo AIGPL_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="aigpl-sf-btn aigpl-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				...
				<?php /* <h3 style="text-align:center"><?php esc_html_e( 'Compare "Album and Image Gallery Plus Lightbox" Free VS Pro', 'album-and-image-gallery-plus-lightbox' ); ?></h3>
