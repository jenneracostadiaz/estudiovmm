...
<div class="wrap wprps-wrap">
	...
	<h2 class="text-center"><?php esc_html_e( 'Album Gallery Image Slider with ', 'album-and-image-gallery-plus-lightbox' ); ?><span class="h-blue"><?php esc_html_e( 'Essential Plugin Bundle Free Trial', 'album-and-image-gallery-plus-lightbox' ); ?></span></h2>
