 ...
 * is not checked, ci_theme_sanitize_checkbox() throws an error.
 * ci_theme_sanitize_checkbox_ref() however evaluates &$input as null so no errors are thrown.
 *
 * @param int|string|bool &$input Input value to sanitize.
 * @return int|string Returns 1 if $input evaluates to 1, an empty string otherwise.
 */
function ci_theme_sanitize_checkbox_ref( &$input ) {
	if ( $input == 1 ) {
		return 1;
	}
 ...
 * @return string
 */
function ci_theme_sanitize_pagination_method( $option ) {
 ...
 */
function ci_theme_sanitize_hex_color( $str, $return_hash = true, $return_fail = '' ) {
 ...
 * @return string
 */
function ci_theme_sanitize_custom_css( $string ) {
