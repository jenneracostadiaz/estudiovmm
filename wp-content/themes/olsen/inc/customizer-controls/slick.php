 ...
 */
class CI_Theme_Customize_Slick_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
		...
		<ul>
			...
			<li>
				<?php
					...
					?><label><span class="customize-control-title"><?php esc_html_e( 'Source category', 'ci-theme' ); ?></span></label><?php
					echo $dropdown;
				?>
			</li>
			...
			<li>
				<label>
					<span class="customize-control-title"><?php _e( 'Post IDs', 'ci-theme' ); ?></span>
					<span class="description customize-control-description"><?php _e( 'You can optionally provide a comma separated list of post IDs. The specific posts will be shown, overriding the source category above. The limit number is still honoured however.', 'ci-theme' ); ?></span>
			...
			<li>
				<label>
					<span class="description customize-control-description"><?php _e( 'Check the box below to display your recent posts from all categories. The limit number is still in place and can be modified below.', 'ci-theme' ); ?></span>
					<input type="checkbox" value="0" <?php $this->link( 'show_recent' ); ?> <?php checked( $this->value( 'show_recent' ), 1 ); ?> />
					<?php _e( 'Show Recent Posts.', 'ci-theme' ); ?>
				</label>
			</li>

			<li>
				<label>
					<span class="customize-control-title"><?php _e( 'Limit posts:', 'ci-theme' ); ?></span>
			...
			<li>
				<label>
					<span class="customize-control-title"><?php _e( 'Slide change effect:', 'ci-theme' ); ?></span>
					<select <?php $this->link( 'fade' ); ?>>
						<option value="" <?php selected( $this->value( 'fade' ), '' ); ?>><?php _ex( 'Slide', 'slick slider slide effect', 'ci-theme' ); ?></option>
						<option value="1" <?php selected( $this->value( 'fade' ), 1 ); ?>><?php _ex( 'Fade', 'slick slider slide effect', 'ci-theme' ); ?></option>
					</select>
				</label>
			</li>
			...
			<li>
				<label>
					<span class="customize-control-title"><?php _e( 'Pause between slides (in milliseconds):', 'ci-theme' ); ?></span>
			...
			<li>
				<label>
					...
					<?php _e( 'Hide post content box', 'ci-theme' ); ?>
				</label>
			</li>
		</ul>
		<?php
